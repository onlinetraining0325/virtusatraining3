...
public class LeaveDetailsController {
    ...
    public ResponseEntity<List<LeaveDetails>> showPendingLeaves(@PathVariable int empId) {

        List<LeaveDetails> leaves = leaveDetailsService.showEmpPendingLeave(empId);
    ...
    public String approveDeny(@PathVariable int leaveId, @PathVariable int mgrId,
